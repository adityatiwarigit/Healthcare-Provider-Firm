...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM login_data WHERE `login_data`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $SQL= "UPDATE `login_data` SET `contactno` = '".$contactno."',`email` = '".$email."',`password` = '".$password."',`type` = '".$type."',`hospital_name`= '".$hospital_name."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            if(!$contactno == "" && !$email == "" && !$password == "" && !$type == "" && !$hospital_name == "")
            {
                $SQL= "INSERT INTO `login_data`(`contactno`, `email`,`password`, `type`, `hospital_name`) VALUES ('".$contactno."','".$email."','".$password."','".$type."','".$hospital_name."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="login_data.php">Login Data</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/login_data.php" method="post">
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            hospital_name = tr.getElementsByTagName("td")[5].innerText;


                            console.log(contactno,email,password,type,hospital_name);
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/login_data.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
