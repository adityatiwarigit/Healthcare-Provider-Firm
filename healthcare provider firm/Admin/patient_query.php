...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM patientquery WHERE `patientquery`.`id` = ".$sno."";
        ...
        else
    {
        ...
        {
            $sno = $_POST['snoEdit'];
            $doctor = $_POST['doctorEdit'];
            $customer_email = $_POST['customer_emailEdit'];
            $query = $_POST['queryEdit'];
            $answer = $_POST['answerEdit'];
            $hospital_name = $_POST['hospital_nameEdit'];
        
            $SQL= "UPDATE `patientquery` SET `doctor` = '".$doctor."',`customer_email` = '".$customer_email."',`query` = '".$query."',`answer` = '".$answer."',`hospital_name`='".$hospital_name."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="patient_query.php">Patient Query</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/patient_query.php" method="post">
                    <input type="hidden" name="snoEdit" id="snoEdit">
                    <div class="mb-3">
                        <label class="form-label">Doctor</label>
                        <input type="text" class="form-control" id="doctorEdit" name="doctorEdit">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Customer Email</label>
                        <input type="text" class="form-control" id="customer_emailEdit" name="customer_emailEdit">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Query</label>
                        <input type="text" class="form-control" id="queryEdit" name="queryEdit">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Answer</label>
                        <input type="text" class="form-control" id="answerEdit" name="answerEdit">
                    </div>   
                    <div class="mb-3">
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            doctor = tr.getElementsByTagName("td")[1].innerText;
                            customer_email = tr.getElementsByTagName("td")[2].innerText;
                            query = tr.getElementsByTagName("td")[3].innerText;
                            answer = tr.getElementsByTagName("td")[4].innerText;
                            hospital_name = tr.getElementsByTagName("td")[5].innerText;

                            console.log(doctor,customer_email,query,answer,hospital_name);
                            doctorEdit.value = doctor;
                            customer_emailEdit.value = customer_email;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/patient_query.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
