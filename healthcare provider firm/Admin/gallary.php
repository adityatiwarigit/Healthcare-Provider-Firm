...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM gallary WHERE `gallary`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $imageTitle = $_POST['imageTitleEdit'];
            $description = $_POST['descriptionEdit'];
        
            $SQL= "UPDATE `gallary` SET `hospital_name` = '".$hospital_name."',`image` = '".$image."',`image_title` = '".$imageTitle."',`description` = '".$description."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            if(!$hospital_name == "" && !$image == "" && !$image_title == "" && !$description == "")
            {
                $SQL= "INSERT INTO `gallary`(`hospital_name`, `image`,`image_title`, `description`) VALUES ('".$hospital_name."','".$image."','".$image_title."','".$description."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="gallary.php">Gallery</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/gallary.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="imageTitleEdit" name="imageTitleEdit">
                    </div>
                    <div class="mb-3">
        ...
        <form action="../Admin/gallary.php" method="post">
                ...
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Image</label>
                    <input type="text" class="form-control" name="image" style="border:1px solid Grey;background-color:#EDEDED" placeholder="xyz.jpg">
                </div>
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Image Title</label>
                    <input type="text" class="form-control" name="image_title" style="border:1px solid Grey;background-color:#EDEDED">
                </div>     
                </div>  <div class="mb-4">
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            image = tr.getElementsByTagName("td")[2].innerText;
                            image_title = tr.getElementsByTagName("td")[3].innerText;
                            description = tr.getElementsByTagName("td")[4].innerText;

                            console.log(hospital_name,image,image_title,description);
                            hospital_nameEdit.value = hospital_name;
                            imageEdit.value = image;
                            imageTitleEdit.value = image_title;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/gallary.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
