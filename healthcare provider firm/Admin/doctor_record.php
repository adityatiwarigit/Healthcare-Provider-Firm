...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM doctors_record WHERE `doctors_record`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $doctor_email = $_POST['doctor_emailEdit'];
            ...
            $SQL= "UPDATE `doctors_record` SET `doctor_name` = '".$doctor_name."', `doctor_email` = '".$doctor_email."',`hospital_name` = '".$hospital_name."',`department` = '".$department."',`OPD` = '".$OPD."',`room_no` = '".$room_no."',`day_schedule` = '".$day_schedule."',`time_schedule` = '".$time_schedule."',`contact_no` = '".$contact_no."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            if(!$doctor_name=="" && !$doctor_email == "" && !$hospital_name == "" && !$department == "" && !$OPD == "" && !$room_no == "" && !$day_schedule == "" && !$time_schedule == "" && !$contact_no == "")
            {
                $SQL= "INSERT INTO `doctors_record`(`doctor_name`, `doctor_email`, `hospital_name`, `department`, `OPD`, `room_no`, `day_schedule`, `time_schedule`, `contact_no`) VALUES ('".$doctor_name."','".$doctor_email."','".$hospital_name."','".$department."','".$OPD."','".$room_no."','".$day_schedule."','".$time_schedule."','".$contact_no."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="doctor_record.php">Doctor's Record</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/doctor_record.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="doctor_emailEdit" name="doctor_emailEdit">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_noEdit" name="contact_noEdit">
                    </div>
        ...
        <form action="../Admin/doctor_record.php" method="post">
                ...
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Doctor's Email</label>
                    <input type="text" class="form-control" name="doctor_email" style="border:1px solid Grey;background-color:#EDEDED">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="contact_no" style="border:1px solid Grey;background-color:#EDEDED" placeholder="000-000-0000">
                </div>     
                ...
                <script>
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/doctor_record.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
