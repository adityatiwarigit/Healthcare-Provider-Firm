...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM ourhospitals WHERE `ourhospitals`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $SQL= "UPDATE `ourhospitals` SET `name` = '".$name."',`city` = '".$city."',`state` = '".$state."',`Type` = '".$Type."',`link`='".$link."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            if(!$name == "" && !$city == "" && !$state == "" && !$Type == "" && !$link == "")
            {
                $SQL= "INSERT INTO `ourhospitals`(`name`, `city`,`state`, `Type`, `link`) VALUES ('".$name."','".$city."','".$state."','".$Type."','".$link."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="our_hospitals.php">Our Hospitals</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/our_hospitals.php" method="post">
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            console.log(name,city,state,Type,link);
                            nameEdit.value = name;
                            cityEdit.value = city;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/our_hospitals.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
