...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM patient_bill WHERE `patient_bill`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $date = $_POST['dateEdit'];
            $bill_link = $_POST['bill_linkEdit'];
            $net_ammount = $_POST['net_ammountEdit'];
        
            $SQL= "UPDATE `patient_bill` SET `hospital_name` = '".$name."',`email` = '".$email."',`date` = '".$date."',`bill_link` = '".$bill_link."',`net_ammount`='".$net_ammount."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            $email = $_POST['email'];
            $date = $_POST['date'];
            $bill_link = $_POST['bill_link'];
            $net_ammount = $_POST['net_ammount'];


            if(!$name == "" && !$email == "" && !$date == "" && !$bill_link == "" && !$net_ammount == "")
            {
                $SQL= "INSERT INTO `patient_bill`(`hospital_name`, `email`,`date`, `bill_link`, `net_ammount`) VALUES ('".$name."','".$email."','".$date."','".$bill_link."','".$net_ammount."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="patient_bill.php">Patient Bill</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/patient_bill.php" method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Bill Link</label>
                        <input type="text" class="form-control" id="bill_linkEdit" name="bill_linkEdit">
                    </div>   
                    <div class="mb-3">
                        <label class="form-label">Net Ammount</label>
                        <input type="text" class="form-control" id="net_ammountEdit" name="net_ammountEdit">
                    </div>                    
        ...
        <form action="../Admin/patient_bill.php" method="post">
                ...
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Bill Link</label>
                    <input type="text" class="form-control" name="bill_link" style="border:1px solid Grey;background-color:#EDEDED" >
                </div>  
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Net Ammount</label>
                    <input type="text" class="form-control" name="net_ammount" style="border:1px solid Grey;background-color:#EDEDED" >
                </div>    
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            bill_link = tr.getElementsByTagName("td")[4].innerText;
                            net_ammount = tr.getElementsByTagName("td")[5].innerText;

                            console.log(name,email,date,bill_link,net_ammount);
                            nameEdit.value = name;
                            emailEdit.value = email;
                            dateEdit.value = date;
                            bill_linkEdit.value = bill_link;
                            net_ammountEdit.value = net_ammount;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/patient_bill.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
