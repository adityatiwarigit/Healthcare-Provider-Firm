...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM department WHERE `department`.`id` = ".$sno."";
        ...
        else
    {
        ...
        {
            $sno = $_POST['snoEdit'];
            $Name = $_POST['Hospital_NameEdit'];
            $Department = $_POST['Department_NameEdit'];
            $Charge = $_POST['Doctor_ChargeEdit'];
            $OPD = $_POST['OPDEdit'];
            $Room = $_POST['Room_NoEdit'];
            $Description = $_POST['DescriptionEdit'];

        
            $SQL= "UPDATE `department` SET `hospital_name` = '".$Name."', `department_name` = '".$Department."',`doctor_charge` = '".$Charge."',`OPD` = '".$OPD."',`room_no` = '".$Room."',`description` = '".$Description."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            $Charge = $_POST['hospital_charge'];
            $OPD = $_POST['OPD'];
            $Room = $_POST['room_no'];
            $Description = $_POST['description'];


            if(!$Name=="" && !$Department == "" && !$Charge == "" && !$OPD == "" && !$Room == "" && !$Description == "")
            {
                $SQL= "INSERT INTO `department`(`hospital_name`, `department_name`, `doctor_charge`, `OPD`, `room_no`, `description`) VALUES ('".$Name."','".$Department."','".$Charge."','".$OPD."','".$Room."','".$Description."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="hospitals.php">Department</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="../Admin/department.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="Department_NameEdit" name="Department_NameEdit">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Doctor's Chrage</label>
                        <input type="text" class="form-control" id="Doctor_ChargeEdit" name="Doctor_ChargeEdit">
                    </div>
                    <div class="mb-3">
        ...
        <form action="../Admin/department.php" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="department_name" style="border:1px solid Grey;background-color:#EDEDED">
                </div>
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Doctor Charge</label>
                    <input type="text" class="form-control" name="hospital_charge" style="border:1px solid Grey;background-color:#EDEDED">
                </div>     
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">OPD</label>
                    <input type="text" class="form-control" name="OPD" style="border:1px solid Grey;background-color:#EDEDED">
                </div>      
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Room</label>
                    <input type="text" class="form-control" name="room_no" style="border:1px solid Grey;background-color:#EDEDED">
                </div>  <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Description</label>
                    <input type="text" class="form-control" name="description" style="border:1px solid Grey;background-color:#EDEDED">
                </div>            
        ...
        <table class="table" id="myTable">
                <thead>
                    ...
                    <th scope="col">Doctor's Charge</th>
                    <th scope="col">OPD</th>
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            Charge = tr.getElementsByTagName("td")[3].innerText;
                            OPD = tr.getElementsByTagName("td")[4].innerText;
                            Room = tr.getElementsByTagName("td")[5].innerText;
                            Description = tr.getElementsByTagName("td")[6].innerText;

                            console.log(Name,Department,Charge,OPD,Room,Description);
                            Hospital_NameEdit.value = Name;
                            Department_NameEdit.value = Department;
                            Doctor_ChargeEdit.value = Charge;
                            OPDEdit.value = OPD;
                            Room_NoEdit.value = Room;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/department.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
