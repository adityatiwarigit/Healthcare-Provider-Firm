...
if (isset($_SESSION['username'])) 
{
    ...
    if(isset($_GET['delete']))
    {
        ...
        $SQL = "DELETE FROM labs WHERE `labs`.`id` = ".$sno."";
        ...
        else
    {
        if(isset($_POST['snoEdit']))
        {
            ...
            $checkup = $_POST['checkupEdit'];
            $link = $_POST['linkEdit'];
        
            $SQL= "UPDATE `labs` SET `name` = '".$name."',`city` = '".$city."',`state` = '".$state."',`checkup` = '".$checkup."',`link`='".$link."' WHERE `id` = ".$sno." ";
            $result = mysqli_query($conn,$SQL);
            if(!$result)
            {
                echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
        ...
        elseif(isset($_POST['upload']))
        {
            ...
            if(!$name == "" && !$city == "" && !$state == "" && !$checkup == "" && !$link == "")
            {
                $SQL= "INSERT INTO `labs`(`name`, `city`,`state`, `checkup`, `link`) VALUES ('".$name."','".$city."','".$state."','".$checkup."','".$link."'); ";
                $result = mysqli_query($conn,$SQL);
                if(!$result)
                {
                    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="lab.php">Lab</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../Admin/lab.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="checkupEdit" name="checkupEdit">
                    </div>   
                    <div class="mb-3">
        ...
        <form action="../Admin/lab.php" method="post">
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Name</label>
                    <input type="text" class="form-control" name="name" style="border:1px solid Grey;background-color:#EDEDED">
                </div>
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">City</label>
                    <input type="text" class="form-control" name="city" style="border:1px solid Grey;background-color:#EDEDED">
                </div>
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">State</label>
                    <input type="text" class="form-control" name="state" style="border:1px solid Grey;background-color:#EDEDED">
                </div>     
                </div>  
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Checkup</label>
                    <input type="text" class="form-control" name="checkup" style="border:1px solid Grey;background-color:#EDEDED" >
                </div>  
                <div class="mb-4">
                    <label class="form-label" style="font-weight:bolder">Link</label>
                    <input type="text" class="form-control" name="link" style="border:1px solid Grey;background-color:#EDEDED" >
                </div>    
                ...
                <script>
                    ...
                    Array.from(edits).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            checkup = tr.getElementsByTagName("td")[4].innerText;
                            link = tr.getElementsByTagName("td")[5].innerText;

                            console.log(name,city,state,checkup,link);
                            nameEdit.value = name;
                            cityEdit.value = city;
                            stateEdit.value = state;
                            checkupEdit.value = checkup;
                            linkEdit.value = link;
                    ...
                    Array.from(deletes).forEach((element)=>
                    {
                        element.addEventListener("click",(e)=>
                        {
                            ...
                            {
                                console.log("yes");
                                window.location = `../Admin/lab.php?delete=${sno}`;
                            }
                            else
                            {
                                console.log("no");
