        ...
        <?php } else { ?>
            <div id="dropdown">
                ...
                <div id="dropdown-content">
                    ...
                    <a href=" report.php?logout=true">Log Out</a>
                </div>
            </div>
        <?php }
        ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="../Hospitals page/patient/report.php">Report</a>
                    </li>
                    <li class="nav-item">
                ...
                <center>
                    <div id="right-align">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $sql_query = "select * from patient_report where email= '" . $_SESSION['useremail'] . "'";
                                $result = mysqli_query($conn, $sql_query);
                                while ($row = mysqli_fetch_array($result)) {
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="../../assets/patient_report/<?php echo $row['report_link'] ?>">click here</a></td>
                                        <td><a href="../../assets/patient_report/<?php echo $row['report_link'] ?>" download="../../assets/patient_report/<?php echo $row['report_link'] ?>">Download</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
