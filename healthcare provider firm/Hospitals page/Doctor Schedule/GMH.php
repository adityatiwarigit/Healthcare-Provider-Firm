        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="../Doctor Schedule/GMH.php">Doctors Schedule</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        <div class="container-fluid">
            ...
            <table class="table table-hover">
                ...
                <?php
                    $sql_query = "select id,doctor_name,day_schedule,time_schedule,department_name,OPD,room_no from doctor_schedule where hospital_name='Government Mahila Hospital';";
