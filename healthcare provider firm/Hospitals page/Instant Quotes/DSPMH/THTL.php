...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="../Instant Quotes/DSPMH/THTL.php">Consult with Doctor</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:50px">Tuberculosis Hospital (Govt.) Thakur ganj Lucknow</h1>
            </center>
            <form method="post" action="">
                <label style="font-size: 30px;font-weight:600;padding-bottom:20px">Select Doctor:-  </label>
                <select name="doctor" id="doctor">
                <?php
                    $sql_query = "select id,doctor_name from doctor_schedule where hospital_name='Tuberculosis Hospital (Govt.) Thakur ganj Lucknow';";
                    $result = mysqli_query($conn, $sql_query);
