...
if(isset($_POST['submit']))
{
   ...
   $hospital = 'Dr. Shyama Prasad Mukharji(civil) Hospital';
...
<!-- 
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../../homepage/THTL.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../../Department/DSPMH.php">Our Departments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../../Doctor Schedule/DSPMH.php">Doctors Schedule</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="../Instant Quotes/DSPMH/DSPMH.php">Consult with Doctor</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../../About page/DSPMH.php">About us</a>
                    </li>
    ...
    <section id="web-content">
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:50px">Dr. Shyama Prasad Mukharji(civil) Hospital</h1>
            </center>
            <form method="post" action="">
                <label style="font-size: 30px;font-weight:600;padding-bottom:20px">Select Doctor:-  </label>
                <select name="doctor" id="doctor">
                <?php
                    $sql_query = "select id,doctor_name from doctor_schedule where hospital_name='Dr. Shyama Prasad Mukharji(civil) Hospital';";
                    $result = mysqli_query($conn, $sql_query);
        ...
        <h3 style="font-weight: bold;font-size:30px;padding-top:50px;padding-bottom:50px">User's Query </h3>
            <table class="table table-hover">
                ...
                <?php
                    $sql_query = "select id,doctor,customer_email,query,answer from patientquery where hospital_name = 'Dr. Shyama Prasad Mukharji(civil) Hospital';";
                    $result = mysqli_query($conn, $sql_query);
                    while ($row = mysqli_fetch_array($result)) {
                ?>
                <tbody>
