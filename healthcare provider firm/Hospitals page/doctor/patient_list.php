            ...
            <?php } else { ?>
                <div id="dropdown">
                    ...
                    <div id="dropdown-content">
                        ...
                        <a href=" patient_list.php?logout=true">Log Out</a>
                    </div>
                </div>
            <?php }
            ?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
                ...
                ?>
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="patient_list.php">Patient List</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Patient Report Type</th>
                                        <th scope="col">Patient Report</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $sql_query = "select * from patient_report where allotted_doctor= '" . $_SESSION['username'] . "'";
                                    $result = mysqli_query($conn, $sql_query);
                                    while ($row = mysqli_fetch_array($result)) {
