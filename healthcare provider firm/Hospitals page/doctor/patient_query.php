...
{
    $sql_query= "delete from doctor_chat where id = '".$id."'";
}
?>
    ...
    <body>
            ...
            <?php } else { ?>
                <div id="dropdown">
                    ...
                    <div id="dropdown-content">
                        ...
                        <a href=" patient_query.php?logout=true">Log Out</a>
                    </div>
                </div>
            <?php }
            ?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
                ...
                ?>
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-weight:bold; font-size:18px;"  href="patient_list.php">Patient List</a>
                        </li>
                        <li class="nav-item">
        ...
        <section id="web-content">
            <div class="container-fluid"> 
                <?php
                    $sql_query = "select * from patient_record where allotted_doctor= '" . $_SESSION['username'] . "'";
                    $result = mysqli_query($conn, $sql_query);
                    while ($row = mysqli_fetch_array($result)) {
                ?>
                    <center>
                    ...
                    <center>
                        <div id="right-align">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        $sql_query = "select * from doctor_chat where allotted_doctor= '" . $_SESSION['username'] . "'";
                                        $result = mysqli_query($conn, $sql_query);
                                        while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success"><a href="../Authentication/updatequery.php?id=<?php echo $row['id'] ?>" style="text-decoration:none;color:white;">Edit</a></button></td>
                                            <form action="patient_query.php?id=<?php echo $row['id'] ?>" method="POST">
                                                <td><button type="submit" class="btn btn-danger" name="delete-btn">Delete</button></td>
                                            </form>                                     
                                        </tr>
                                    <?php  
                                    }
