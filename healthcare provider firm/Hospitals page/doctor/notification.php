...
<head>
    ...
    <body>
            ...
            <?php } else { ?>
                <div id="dropdown">
                    ...
                    <div id="dropdown-content">
                        ...
                        <a href=" notification.php?logout=true">Log Out</a>
                    </div>
                </div>
            <?php }
            ?>
        ...
        <section id="web-content">
            <?php
               $sql_query = "select hospital_name from doctors_record where doctor_name= '" . $_SESSION['username'] . "'";
               $result = mysqli_query($conn, $sql_query);
            ...
            <?php
                ...
                $sql_query = "select * from notification where hospital_name= '" . $hospital . "'";
                $result = mysqli_query($conn, $sql_query);
                while($row = mysqli_fetch_array($result))
                {
                ?>
                <div style="border:1px solid skyblue;background-color:lightblue">
                    <h6><?php echo $row['notification'] ?><p style="text-align: right;padding-right:2px;"><?php echo $row['date'] ?><button>Delete</button></p></h6>
                </div>
            <?php
                }
            ?>
