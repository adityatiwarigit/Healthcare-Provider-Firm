...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="DrShyamaPrasadMukharji.php">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:20px">Dr. Shyama Prasad Mukharji(civil) Hospital</h1>
                <p style="font-weight:400;font-size:28px;padding-bottom:50px">Park Road,Hazratganj,Lucknow ,Uttar Pradesh-226001</p>

            </center>
            <div class="container-fluid">
                <img src="../../assets/images/DSPMH/logo/DSPMH1.jpg" height="600px" class="img-fluid" width="100%" alt="DSPMH">
            </div>
            <center>
