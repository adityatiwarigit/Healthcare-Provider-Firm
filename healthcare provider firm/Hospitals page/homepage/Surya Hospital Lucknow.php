...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="Surya Hospital Lucknow.php">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:20px">Surya Hospital Lucknow</h1>
                <p style="font-weight:400;font-size:28px;padding-bottom:50px">Scheme, Kanpur - Lucknow Rd, near Vishal Megamart, Sector I, LDA Colony, Lucknow, Uttar Pradesh 226012</p>

            </center>
            <div class="container-fluid">
                <img src="../../assets/images/Surya Hospital Lucknow/logo/surya.jpg" class="img-fluid" height="600px" width="100%" alt="THTL">
            </div>
            <center>
