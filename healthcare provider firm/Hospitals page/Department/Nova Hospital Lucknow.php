        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="../Department/Nova Hospital Lucknow.php">Our Departments</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="web-content">
        <div class="container-fluid">
            ...
            <table class="table table-hover">
                ...
                <?php
                    $sql_query = "select id,department_name,OPD,room_no,description from department where hospital_name='Nova Hospital Lucknow';";
