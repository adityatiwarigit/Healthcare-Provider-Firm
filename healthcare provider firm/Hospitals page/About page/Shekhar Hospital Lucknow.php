        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../homepage/Shekhar Hospital Lucknow.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../Department/Shekhar Hospital Lucknow.php">Our Departments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../Doctor Schedule/Shekhar Hospital Lucknow.php">Doctors Schedule</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" style="font-weight:bold; font-size:18px;" href="../Instant Quotes/DSPMH/Shekhar Hospital Lucknow.php">Consult with Doctor</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" style="font-weight:bold; font-size:18px;" aria-current="page" href="Shekhar Hospital Lucknow.php">About us</a>
                    </li>
    ...
    <section id="web-content">
        <div id="upper-web-content">
            <div class="container-fluid" style="padding:5px; margin: 2px;padding-bottom: 0px;margin-bottom: 0px;">
                <div id=left-align>
                    <img src="../../assets/images/Shekhar Hospital Lucknow/logo/Shekhar.jpg" class="img-fluid" alt="about img" height="500px" width="550px" />
                </div>
                <div id="right-align">
                    <h1>Shekhar Hospital<br>(private) <br>Lucknow</h1>
        ...
        <div id="middle-web-content">
            ...
            <div class="card mb-3">
                <img src="../../assets/images/Shekhar Hospital Lucknow/logo/Shekhar.jpg" class="card-img-top img-fluid" alt="..." height="600px">
            </div>

            <div class="row row-cols-1 row-cols-md-2 g-4">
                <?php
                $sql_query = "select id,hospital_name,image,image_title,description from gallary where hospital_name = 'Shekhar Hospital Lucknow';";
                $result = mysqli_query($conn, $sql_query);
                while ($row = mysqli_fetch_array($result)) {
                ?>
                    <div class="col" style="padding: 15px 0px">
                        <div class="card">
                            <img src="../../assets/images/Shekhar Hospital Lucknow/images/<?php echo $row['image'] ?>" class="card-img-top" alt="...">
            ...
            <div class="card mb-3">
                <img src="../../assets/images/Shekhar Hospital Lucknow/logo/Shekhar.jpg" class="card-img-top img-fluid" alt="..." height="700px">
            </div>
        </div>
    </section>
