...
<head>
    ...
    <style>
        * {
        ...
        .other {
            width: 60%;
            background-image: url("../healthcare provider firm/assets/logo/logo1.gif");
        ...
        .flex-rev textarea {
            border: none;
            background: rgb(0, 212, 255);
            background: linear-gradient(180deg, rgba(0, 213, 258, 1) 0%, rgba(255, 255, 255, 1) 0%, rgba(212, 235, 243, 1) 100%, rgba(255, 255, 255, 1) 100%);
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="font-weight:bold; font-size:18px;" href="contact.php">Contact us</a>
                    </li>
                </ul>
            </div>
        </nav>
                        ...
                        <div class="info">
                            ...
                            <div class="svg-wrap">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.211 485.211">
                                    ...
                                    healthcareprovider@gmail.com</a>
                            </div>
                            <h3>Connect</h3>
                            <div class="svg-wrap">
