...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#e3fcfc;">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="font-weight:bold; font-size:18px;" href="hospitals.php">Our Hospitals</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex">
                    <input class="form-control me-2" type="search" placeholder="Enter Hospital's Name/city/type etc." aria-label="Search">
    ...
    <section id="web-content">
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:50px">Select the best Hospitals suitable for you.</h1>
            </center>
        </div>
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:50px">List of Government Hospitals</h1>
            </center>
            <table class="table table-hover">
                ...
                <?php
                    $sql_query = "select id,name,city,state,Type,link from ourhospitals where Type='government';";
                ...
                <tbody>
                    <tr>
                        ...
                        <?php if ($row['link']!=="") {
                        ?>
                        <td><a href="../healthcare provider firm/Hospitals page/homepage/<?php echo $row['link']?>">Show more</a></td>
                       <?php
                       } 
                       else {
                       ?>
        ...
        <div class="container-fluid">
            <center>
                <h1 style="font-weight: bold;font-size:50px;padding-top:50px;padding-bottom:50px">List of Private Hospitals</h1>
            </center>
            <table class="table table-hover">
                <thead>
                    <tr>
                ...
                <?php
                    $sql_query = "select id,name,city,state,Type,link from ourhospitals where Type='private';";
                    $result = mysqli_query($conn, $sql_query);
                    while ($row = mysqli_fetch_array($result)) {
                ?>
                <tbody>
